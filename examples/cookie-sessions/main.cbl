      ...
      **********************
       ...
       procedure division using request, connect.
           ...
           perform varying i from 1 by 1 until i is greater cookie-size
               if cookie-parse-name(i) is equal "count" then
                   set cookie-ptr to cookie-parse-value(i)
                   exit perform
               end-if
           end-perform.
           ...
           move "count" to cookie-name.
           move cookie-ptr to cookie-value.
           move "/" to cookie-path.
           move "SESSION" to cookie-expires.
